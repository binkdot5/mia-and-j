...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
	...
	<td class="woocommerce-table__product-name product-name">
		...
		echo apply_filters( 'woocommerce_order_item_quantity_html', ' <br /><span class="product-quantity">' . sprintf( 'quantity:&nbsp;%s', $qty_display ) . '</span>', $item ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
